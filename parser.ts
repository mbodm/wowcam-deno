...
export function validateAddonSiteJsonString(jsonString: string): results.LogicResult {
    ...
    if (!file.id) {
        logger.logError('no mainFile.id in JSON');
